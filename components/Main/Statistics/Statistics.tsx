    ...
    return (
        <Box sx={{
            ...
            <Paper sx={{ width: "100%", padding: 2, marginTop: 2, marginBottom: 2 }} elevation={2}>
                <StatisticsChart category={addictions[activeStep].category} info={addictions[activeStep].info[activeInfo]}></StatisticsChart>
                ...
                <Box sx={{ width: "100%", marginTop: 2, display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: "80%", display: "flex", justifyContent: "space-between" }}>
                        ...
                        <Typography sx={{ display: "flex", alignItems: "center" }}>{addictions[activeStep].category}</Typography>
                        <Button
                            size="small"
                            onClick={handleNext}
